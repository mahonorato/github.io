...
<html lang="en-US">
  ...
  Mapas (ツ)
</a></div> <!----></nav>  <ul class="sidebar-links"><li><a href="/" aria-current="page" class="sidebar-link">Home</a></li></ul> </aside> <main class="page"> <div class="theme-default-content content__default"><h1 id="entities"><a href="#entities" class="header-anchor">#</a> entities <a href="https://npmjs.org/package/entities" target="_blank" rel="noopener noreferrer"><img src="http://img.shields.io/npm/v/entities.svg" alt="NPM version"><span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a> <a href="https://npmjs.org/package/entities" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/npm/dm/entities.svg" alt="Downloads"><span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a> <a href="http://travis-ci.org/fb55/entities" target="_blank" rel="noopener noreferrer"><img src="http://img.shields.io/travis/fb55/entities.svg" alt="Build Status"><span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a> <a href="https://coveralls.io/r/fb55/entities" target="_blank" rel="noopener noreferrer"><img src="http://img.shields.io/coveralls/fb55/entities.svg" alt="Coverage"><span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" x="0px" y="0px" viewBox="0 0 100 100" width="15" height="15" class="icon outbound"><path fill="currentColor" d="M18.8,85.1h56l0,0c2.2,0,4-1.8,4-4v-32h-8v28h-48v-48h28v-8h-32l0,0c-2.2,0-4,1.8-4,4v56C14.8,83.3,16.6,85.1,18.8,85.1z"></path> <polygon fill="currentColor" points="45.7,48.7 51.3,54.3 77.2,28.5 77.2,37.2 85.2,37.2 85.2,14.9 62.8,14.9 62.8,22.9 71.5,22.9"></polygon></svg> <span class="sr-only">(opens new window)</span></span></a></h1> <p>En- &amp; decoder for XML/HTML entities.</p> <h2 id="how-to"><a href="#how-to" class="header-anchor">#</a> How to…</h2> <h3 id="install-entities"><a href="#install-entities" class="header-anchor">#</a> …install <code>entities</code></h3> <div class="language- extra-class"><pre><code>npm i entities
</code></pre></div><h3 id="use-entities"><a href="#use-entities" class="header-anchor">#</a> …use <code>entities</code></h3> <div class="language-javascript extra-class"><pre class="language-javascript"><code><span class="token keyword">var</span> entities <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&quot;entities&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token comment">//encoding</span>
entities<span class="token punctuation">.</span><span class="token function">encodeXML</span><span class="token punctuation">(</span><span class="token string">&quot;&amp;#38;&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>  <span class="token comment">// &quot;&amp;amp;#38;&quot;</span>
entities<span class="token punctuation">.</span><span class="token function">encodeHTML</span><span class="token punctuation">(</span><span class="token string">&quot;&amp;#38;&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// &quot;&amp;amp;&amp;num;38&amp;semi;&quot;</span>
<span class="token comment">//decoding</span>
entities<span class="token punctuation">.</span><span class="token function">decodeXML</span><span class="token punctuation">(</span><span class="token string">&quot;asdf &amp;amp; &amp;#xFF; &amp;#xFC; &amp;apos;&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>  <span class="token comment">// &quot;asdf &amp; ÿ ü '&quot;</span>
entities<span class="token punctuation">.</span><span class="token function">decodeHTML</span><span class="token punctuation">(</span><span class="token string">&quot;asdf &amp;amp; &amp;yuml; &amp;uuml; &amp;apos;&quot;</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// &quot;asdf &amp; ÿ ü '&quot;</span>
</code></pre></div> <hr> <p>License: BSD-2-Clause</p></div> <footer class="page-edit"><!----> <!----></footer> <!----> </main></div><div class="global-ui"></div></div>
    <script src="/assets/js/app.0564bdef.js" defer></script><script src="/assets/js/2.ce93f9fe.js" defer></script><script src="/assets/js/46.5cd8992a.js" defer></script>
  </body>
</html>
